...
3. **DECISIONS.md悬决点全部有了答复**：①"先入住交接、再生成电子签约"**强制**；②通知送达只写双方电话+微信身份，签署页**删除"送达地址"占位符**；③【连续居住天数】【累计居住天数】【检查提前通知小时数】【遗留物保管天数】【不续租通知天数】全部做成**全局配置项**（跟提醒参数一样放系统设置，默认值建议30/90/24小时/30/30天，GasCan可随时在界面改）；④附件三"钥匙及门禁数量/房屋现状说明/影像存档号"**整体不要**；⑤附件五费用细则文案**GasCan还没拿到**（要问他母亲），先写"以实际发生为准"占位，拿到后他提供再更新配置。
