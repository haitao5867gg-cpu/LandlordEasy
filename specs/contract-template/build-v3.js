...
const body = [
  ...
  art('第一条　房屋与用途'),
  item('1. 本房屋仅用于居住，居住人限于乙方及上表所列共同居住人，总人数不超过【单间人数上限】人。乙方不得将房屋用于经营、办公、仓储。'),
  item('2. 甲方于【租赁起始日】交付房屋。双方按附件《房屋交接清单》逐项确认设施状况，并拍照或录像留存，作为交接和退房时核对的依据。'),
  ...
  item('2. **租期届满或合同解除后，乙方交还房屋并结清费用的，甲方应在【押金退还天数】个工作日内退还押金。甲方可以从押金中扣除：乙方未付的租金、费用和赔偿款，本合同约定的违约金、清洁费，以及处理遗留物品的合理费用；扣除时应向乙方提供明细。押金不足以抵扣的，乙方应当补足。**'),
  ...
  item('2. **因乙方使用不当或过错造成房屋、设施损坏的，维修费用由乙方承担，并应在维修完成时当场支付；无法修复的，按同类物品市场价格扣除合理折旧后赔偿。因乙方原因造成漏水等致使他人受损的，由乙方承担赔偿责任。**'),
  item('3. 未经甲方书面同意，乙方不得改动房屋结构及设施、增设隔断、改动水电线路；擅自改动的，应恢复原状并赔偿损失。乙方自行添置的物品，退房时可以带走；其中已固定安装在房屋上、拆除可能损坏房屋的，应提前通知甲方，经甲方同意后再拆除，造成损坏的应予修复。'),
  ...
  item('2. 租期届满或合同解除后，乙方应在届满之日或解除通知载明的日期前搬离，按原状返还房屋和设施，交还钥匙和门禁卡，结清费用。退房时应保持房内整洁，否则甲方可以收取清洁费【清洁费金额】元。**乙方逾期不搬离的，按日租金（月租金÷30）支付占用期间的房屋使用费。**'),
  ...
  art('第九条　征收与不可抗力'),
  item('因政府征收、拆迁、规划调整或不可抗力等非双方原因致使本合同无法履行的，合同终止，双方互不承担违约责任；甲方应尽可能提前通知乙方，按实际居住天数结算租金，退还剩余租金和押金。'),

  art('第十条　其他'),
  item('1. 上表所列电话是双方的联系方式。按该电话发送的短信、微信通知，发出满24小时视为送达；一方变更电话应及时告知对方，未告知的，按原电话发送的通知视为送达。'),
  item('2. 本合同以电子签名方式签订，附件是本合同的组成部分。'),
  item('3. 本合同未尽事宜，依照有关法律法规执行，或者由双方另行书面约定。'),
  item('4. 补充条款：【补充条款内容；无则填“无”】'),
