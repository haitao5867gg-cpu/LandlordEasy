...
export class LeasesService {
  ...
  private async launchContractSigningTaskInternal(
    ...
    const pdfData: ContractPdfData = {
      ...
      maxOccupantsPerRoom: settings.maxOccupantsPerRoom ?? 2,
      rentOverdueTerminateDays: settings.rentOverdueTerminateDays ?? 15,
      disguisedSubletDays: settings.disguisedSubletDays ?? 15,
